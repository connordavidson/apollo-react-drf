    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parentCategory', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='api.ItemCategory')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='item',
            name='category',
            field=models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='api.ItemCategory'),
        ),
